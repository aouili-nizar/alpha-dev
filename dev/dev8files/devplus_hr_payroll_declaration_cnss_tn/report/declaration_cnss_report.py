...
class report_declaration_cnss(osv.AbstractModel):
    _name = 'report.devplus_hr_payroll_declaration_cnss_tn.report_declaration_cnss'
    _inherit = 'report.abstract_report'
    _template = 'devplus_hr_payroll_declaration_cnss_tn.report_declaration_cnss'
    _wrapped_report_class = declaration_cnss_report

class report_recapitulatif_cnss(osv.AbstractModel):
    _name = 'report.devplus_hr_payroll_declaration_cnss_tn.report_recapitulatif_cnss'
    _inherit = 'report.abstract_report'
    _template = 'devplus_hr_payroll_declaration_cnss_tn.report_recapitulatif_cnss'
    _wrapped_report_class = declaration_cnss_report
